...
class BitcoinNode(Node):
    ...
    def load_tx_out_hash_table(self, pickle_path: str, reset: bool = False):
        ...
        with open(pickle_path, 'rb') as file:
            ...
            end_time = time.time()
            logger.info(f"Successfully loaded tx_out hash table", extra = logger_extra_data(pickle_path = pickle_path, time_taken = end_time - start_time))
    ...
    def get_current_block_height(self):
        ...
        try:
            ...
            logger.error(f"RPC Provider with Error", extra = logger_extra_data(error = {'exception_type': e.__class__.__name__,'exception_message': str(e),'exception_args': e.args}))
        finally:
